...
```HTML 
<!--- I have not yet completed Milestone 2 & 3. Code needs to be input.-->
<!--- BlueStamp logo needs to be replaced with completed project. -->
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/?v=DEBpPv8869U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
